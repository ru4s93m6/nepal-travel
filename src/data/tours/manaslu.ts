...
export const manasluTour: TourData = {
  ...
  locales: {
    ...
    'zh-tw': {
      ...
      overview: '馬納斯魯大環線 (Manaslu Circuit) 是一條絕美且遊客較少的經典路線，被譽為安娜普納環線的最佳替代路線。自 1992 年才正式對外國旅客開放，這裡完整保留了最純粹的自然風光與濃厚的藏族文化。這趟為期 16 天的旅程將帶您穿梭於古老村落、亞熱帶森林與高山草甸，最終挑戰跨越海拔高達 5,162 公尺的拉凱山口 (Larke Pass)。對於渴望遠離人群、尋求最純粹高山體驗的資深健行者來說，這絕對是一次完美的冒險。\n\n請注意：本行程天數（16天）為預估標準，實際行程會視旅客的體能狀況與高山適應程度進行彈性調整。我們的首要任務是確保您在安全、健康的前提下，順利完成這趟壯麗的旅程。',
      highlights: [
