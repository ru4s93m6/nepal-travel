    ...
    'zh-tw': {
      ...
      itinerary: [
        ...
        },
        {
          ...
          description: '今天是這趟不丹之旅的重頭戲！早餐後，我們驅車前往步道口，準備健行前往名聞遐邇的虎穴寺 (Paro Taktsang)。這座神聖的寺廟奇蹟般地懸掛在距離谷底 900 公尺高的垂直懸崖上，景色極度震撼。上山徒步約需 2 至 3 小時，下山約 1.5 小時，途中我們會在半山腰的景觀咖啡廳享用午餐與休息。今晚夜宿帕羅。'
        },
        {
          day: 4,
          title: '告別雷龍之國，飛返加德滿都',
