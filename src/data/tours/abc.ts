...
export const abcTour: TourData = {
  ...
  locales: {
    ...
    'zh-tw': {
      ...
      highlights: [
        '抵達海拔 4,230 公尺的安娜普納基地營，享受 360 度無死角雪山全景',
      ...
      itinerary: [
        ...
        },
        {
          ...
          description: '安娜普納基地營擁有無死角的 360 度環繞美景。抵達這個絕佳觀景點後，我們將盡情欣賞魚尾峰、安娜普納南峰、安娜普納一峰、Hiuchuli 等群峰令人著迷的壯麗景色。行程的高潮在今天告一段落，隨後我們將從安娜普納基地營折返，走一條相對輕鬆的下坡路線前往 Dobhan（2600m）。'
        },
        {
          day: 6,
