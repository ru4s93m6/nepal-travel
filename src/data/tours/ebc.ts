  ...
  locales: {
    ...
    'zh-tw': {
      ...
      itinerary: [
        ...
        {
          day: 12,
          title: '下撤至南崎市場 Namche Bazaar (3,441m)',
          description: '從培利切出發，我們走一條略為不同的路線下山前往 Orsho，然後到 Pangboche 村。這裡擁有該區域最古老的修道院，據說裡面還保存著雪人（Yeti）的頭皮和骨頭呢！我們將大山留在身後，繼續下坡經過天波切修道院，最後在下午回到繁華的南崎市場。'
        },
        {
          day: 13,
